...
public class BookMain {
        ...
        while (true) {
            ...
            switch (inputData) {
                ...
                case 2 -> {
                    ...
                    BookClass book = findBook(findTitle, bookList);
                ...
                case 5 -> {
                    ...
                    buyTheBook(findBook(buyBookTitle, bookList));
                }
            }
    ...
    private static void bookInfo(BookClass emptyBook) {
        if (emptyBook instanceof EBookClass eBook) eBook.deviceInfo();
        else if (emptyBook instanceof PaperBookClass paperBook) paperBook.sizeInfo();
    }
